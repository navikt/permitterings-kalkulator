    ...
    return (
        <>
            ...
            <Normaltekst className="textair">
                ...
                du dekket 50 prosent av lønnsutgiftene dine.
            </Normaltekst>
            <Normaltekst className="textair">
                Du må søke senest 31 oktober 2020 dersom du vil ha tilbakebetalt
                lønn du har utbetalt til permitterte fra 20 mars. Vi jobber med
                en søknad og kommer med mer informasjon når den er klar.
            </Normaltekst>
        </>
    );
};
