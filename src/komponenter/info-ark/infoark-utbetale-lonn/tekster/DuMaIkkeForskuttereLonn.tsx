...
const DuMaIkkeForskuttereLonn = () => {
    return (
        <>
            <Normaltekst>
                Du skal ikke forskuttere lønn til ansatte for 3. til 20 dag for
                alle permitteringer som starter fra 20. april eller senere. Du
                kan ikke kreve å få tilbake utbetalt lønn for permitteringer som
                starter etter denne datoen.
            </Normaltekst>
